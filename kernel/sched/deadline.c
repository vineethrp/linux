...
static void update_curr_dl_se(struct rq *rq, struct sched_dl_entity *dl_se, s64 delta_exec)
{
	...
	trace_sched_stat_runtime(dl_task_of(dl_se), delta_exec, 0);
...
static inline void __set_next_task_dl(struct rq *rq, struct task_struct *p, bool first)
{
