 ...
 */
int nop_pvsched_vcpu_register(struct pid *pid)
{
	return 0;
}
void nop_pvsched_vcpu_unregister(struct pid *pid)
{
}
void nop_pvsched_notify_event(void *addr, struct pid *pid, u32 event)
{
}
